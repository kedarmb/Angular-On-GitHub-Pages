...
export class NavbarComponent implements OnInit {
  ...
  constructor(location: Location, private element: ElementRef, public hs: HelperService, private router: Router) {
  ...
  navigate(value) {
    if (value && value.toLowerCase().indexOf('dashboard') !== -1) {
      ...
      value &&
      (value.toLowerCase().indexOf('organisation') !== -1 || value.toLowerCase().indexOf('organization') !== -1)
    ) {
