...
export const errorMsg = {
  ...
  nameErr:
    "Name must be at least 5 chars, must not exceed 30 chars & must not start or end with special chars",
  orgName: "Organization Name",
  nameMessage:
    "This field should not start with any special charecters and should not contain special charecters",
  passwordMessage:
    "Password should be at least 8 digits & should contain one number and one special charecter",
