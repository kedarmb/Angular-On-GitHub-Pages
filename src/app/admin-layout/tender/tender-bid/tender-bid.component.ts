...
export class TenderBidComponent implements OnInit {
  ...
  ngOnInit() {
    this.hs.tenderId.subscribe(tenderId => {
    ...
    if (this.tenderId) {
      this.httpService.getSubmittedBid(this.tenderId).subscribe(
        response => {
    ...
    } else this.toastr.info('tender not found');
  }
  ...
  getTenderById(tenderId) {
    return this.httpService.getTenderDetailById(tenderId).subscribe(
      response => {
  ...
  saveBid() {
    ...
    return this.httpService.saveBid(tenderDetails).subscribe(
      response => {
  ...
  submitFinalBid() {
    ...
    return this.httpService.submitFinalBid(tenderDetails).subscribe(
      response => {
        this.bidEnable = false;
        console.log('ssssssssssss', response.body);
        this.tender = response.body;
